...
const navigation = [
  ...
  { name: 'Personal Appraisal', href: '/appraisal', icon: UserCircleIcon },
  { name: 'Idea Creator', href: '/ideas', icon: LightBulbIcon },
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <Menu as="div" className="relative">
                  ...
                  >
                    <Menu.Items className="absolute bottom-full left-0 z-10 mb-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        <Menu.Item>
                          {({ active }) => (
                            <Link
